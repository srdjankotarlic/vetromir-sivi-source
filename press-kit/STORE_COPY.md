...
Gvozdanovim kovačkim oružjem ili ovladaj potpuno drugačijim arsenalima Ognjena,
Rujane, Jasenke i Noćene. Svaki junak ima sopstveno kretanje, odbranu, resurs,
...
- ručno režirana proceduralna grafika i adaptivni zvuk
- bez naloga, oglasa, telemetrije i kupovina u aplikaciji
- potpuno besplatno
...
Otvori DMG, prevuci `Vetromir.app` u Applications i prvi put pokreni desnim klikom
na aplikaciju pa `Open`. Trenutno izdanje nije Apple notarizovano, pa macOS može
tražiti potvrdu u `System Settings > Privacy & Security > Open Anyway`.
...
- code-drawn visuals and adaptive audio
- no accounts, ads, telemetry, or in-app purchases
- completely free
